...
document.body.style.backgroundImage = "url('./planet/galaxy.gif')"
...
btn.addEventListener('click',function(){
  ...
  if(input.value.trim() != "" && select.value != "Bir gezegen seç" && !isNaN(input.value)){
    ...
    if(gezegen == 'earth'){
      img.setAttribute("src", "./planet/earth.png")
      sonuc = kilo * 9.81
    }
    else if(gezegen == 'jupiter'){
      img.setAttribute('src',"./planet/jupiter.png")
      sonuc = kilo * 24.8
    }
    else if(gezegen == "mars"){
      img.setAttribute('src',"./planet/mars.png")
      sonuc = kilo * 3.7
    }
    else if(gezegen == "mercury"){
      img.setAttribute('src',"./planet/mercury.png")
      sonuc = kilo * 3.7
    }
    else if(gezegen == 'moon'){
      img.setAttribute('src','./planet/moon.png')
      sonuc = kilo * 1.6
    }
    else if(gezegen == "neptune"){
      img.setAttribute("src","./planet/neptune.png")
      sonuc = kilo * 11.15
    }
    else if(gezegen == "pluto"){
      img.setAttribute('src','./planet/pluto.png')
      sonuc = kilo * 0.62
    }
    else if(gezegen == "saturn"){
      img.setAttribute('src','./planet/saturn.png')
      sonuc = kilo * 10.44
    }
    else if(gezegen == "uranus"){
      img.setAttribute('src',"./planet/uranus.png")
      sonuc = kilo * 8.87
    }
    else if (gezegen == "venus"){
      img.setAttribute('src',"./planet/venus.png")
      sonuc = kilo * 8.87
    }
